...
const paginatedItems = computed(() => {
  console.log('en Paginator items:', props.items)
...
<template>
  <div class="block w-full h-[calc(100vh-6.25rem)] bg-gray-800 text-center">
    <div class="mt-2.5 h-[70%] mini-card-view-container rounded-lg">
      <div v-for="item in paginatedItems" :key="item.DocumentItemsId">
        <slot :item="item" />
      </div>
